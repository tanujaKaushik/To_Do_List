...
export default function Stats(){
    ...
    //return(
        // <>
        //     <div className="h-screen bg-gradient-to-r from-orange-800 to-fuchsia-800">
        ...
        //         <div className="bg-white h-96 my-10" style={{margin:"30px 300px",padding:"30px 50px"}}>
        //             <div className="text-black text-4xl text-center"> Statistics</div>
        //             <section>
