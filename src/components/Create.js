...
export default function Create(){
    ...
    const AddItem=(e)=>{
        ...
        setInput({date:input.date,task:"",priority:input.priority,done:"f"});
    };
    ...
    const submit= async e => {
        e.preventDefault();
        await axios.post("http://localhost:3001/lists",{list :inputList})
        navigate("/");
    ...
    return(
        <>
            <div className="min-wmin h-screen bg-gradient-to-r from-violet-800 to-fuchsia-800">
            ...
            <div className="bg-white" style={{margin:"2vh 35vh",padding:"1vh 5vw",height:"85vh",width:"auto"}}>
                ...
                <div className="flex-none w-96 relative">
                    <img src="img/To-Do.png" alt="" className="absolute inset-0 w-full  object-cover rounded-lg" loading="lazy" />
                </div>
                <form className="flex-auto p-6" onSubmit={ e => submit(e)}>
                    ...
                    <div className="flex-auto flex space-x-4">     
                        ...
                        <button className="mt-5 mb-3 px-10 py-3 rounded-md text-xl font-bold transition ease-in-out delay-150 bg-fuchsia-500  hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300">
                            SAVE
                        </button>
                        </div>
                    </div>
